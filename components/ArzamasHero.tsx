...
export default function ArzamasHero({ theme }: ArzamasHeroProps) {
  ...
  const isAncientMyths = theme.id === 'ancient-myths';
  ...
  return (
    <section className="relative w-full bg-[#fdfcf8] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-24">
        <div className={`grid ${isAncientMyths ? 'md:grid-cols-2' : 'md:grid-cols-1'} gap-12 items-center`}>
          {/* Left: Title */}
          <div className={`z-10 ${!isAncientMyths ? 'max-w-4xl mx-auto text-center' : ''}`}>
          ...
          {/* Right: Collage - only for ancient-myths */}
          {isAncientMyths && (
